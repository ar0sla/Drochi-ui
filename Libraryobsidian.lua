...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        --// Script Icon (always shown next to title) \\--
        local ScriptIcon = New("ImageLabel", {
            BackgroundTransparency = 1,
            Size = UDim2.fromOffset(20, 20),
            Image = "rbxassetid://94041871724354",
            Parent = TitleHolder,
        })
        ...
        local IconWidth = (WindowInfo.Icon and WindowInfo.IconSize.X.Offset + 6 or 0) + 26
        local X = Library:GetTextBounds(
            WindowInfo.Title,
            Library.Scheme.Font,
            20,
            TitleHolder.AbsoluteSize.X - IconWidth - 12
        )
