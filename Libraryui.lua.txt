...
do
    ...
    -- ============================================
    -- drochik ui - by ar0sla (github) & voidena
    -- ============================================
    Library = {
        Name = "drochik ui",
        Authors = {"ar0sla (github)", "voidena"},
        ...
        Folders = {
            Directory = "drochik_ui",
            Configs = "drochik_ui/Configs",
            Assets = "drochik_ui/Assets",
        },
        ...
        BackgroundImage = "rbxassetid://137996491500110"
    }
    ...
    -- ============================================
    -- ЧЕРНО-БЕЛАЯ ТЕМА drochik ui
    -- ============================================
    local Themes = {
        ["drochik_ui"] = {
            ["AccentGradient"] = FromRGB(255, 255, 255),   -- Белый градиент
            ["Background 2"] = FromRGB(18, 18, 18),         -- Очень темный серый
            ["Background"] = FromRGB(12, 12, 12),           -- Почти черный
            ["Text"] = FromRGB(255, 255, 255),              -- Белый текст
            ["Outline"] = FromRGB(35, 35, 35),              -- Темно-серая обводка
            ["Section Top"] = FromRGB(25, 25, 25),          -- Темный заголовок
            ["Section Background"] = FromRGB(15, 15, 15),   -- Темный фон секции
            ["Section Background 2"] = FromRGB(20, 20, 20), -- Альтернативный фон
            ["Accent"] = FromRGB(255, 255, 255),            -- Белый акцент
            ["Element"] = FromRGB(30, 30, 30)               -- Элементы UI
        }
    }

    Library.Theme = TableClone(Themes["drochik_ui"])
    ...
    -- ============================================
    -- WINDOW - с фоновой картинкой drochik ui
    -- ============================================
    Library.Window = function(self, Data)
        Data = Data or { }

        local Window = {
            Name = Data.Name or Data.name or "drochik ui",
            SubName = Data.SubName or Data.subname or "by ar0sla & voidena",
        ...
        local Items = { } do
            ...
            -- ============================================
            -- ФОНОВАЯ КАРТИНКА drochik ui (137996491500110)
            -- ============================================
            Items["BackgroundImage"] = Instances:Create("ImageLabel", {
                Parent = Items["MainFrame"].Instance,
                Name = "BackgroundImage",
                Image = "rbxassetid://137996491500110",
                BackgroundTransparency = 1,
            ...
            Items["BackgroundOverlay"] = Instances:Create("Frame", {
                Parent = Items["MainFrame"].Instance,
            ...
            Instances:Create("UICorner", {
                Parent = Items["BackgroundOverlay"].Instance,
                Name = "\0",
                CornerRadius = UDimNew(0, 4)
            })
            ...
            -- ============================================
            -- ЛОГОТИП И ЗАГОЛОВОК drochik ui
            -- ============================================
            ...
            do
                ...
                }) SettingsItems["Settings"]:AddToTheme({BackgroundColor3 = "Background 2"})
...
Library.Pages.GlobalChat = function(self, Side)
    ...
    local Items = { } do 
        Items["GlobalChat"] = Instances:Create("Frame", {
            ...
            BorderSizePixel = 0,
            BackgroundColor3 = FromRGB(18, 18, 18)
        })  Items["GlobalChat"]:AddToTheme({BackgroundColor3 = "Background 2"})
    ...
    Items["GlobalChat"].Instance.ZIndex = 3
    Items["SendIcon"].Instance.ZIndex = 4
...
Library.Sections.Button = function(self, Data)
    ...
    return Button
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            Items["RealDropdown"]:OnHoverLeave(function()
                ...
                Items["ArrowIcon"]:Tween(nil, {ImageColor3 = FromRGB(180, 180, 180)})
                Items["Gradient"].Instance.Enabled = false
            end)
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    Items["ArrowIcon"]:Tween(nil, {Rotation = 0, ImageColor3 = FromRGB(180, 180, 180)})
                    Items["Gradient"].Instance.Enabled = false
                end
        ...
        -- ============================================
        -- CREATE COLORPICKER (черно-белый)
        -- ============================================
        Library.CreateColorpicker = function(self, Data)
            ...
            local Items = { } do
                ...
                if not Data.Parent2.Instance:FindFirstChild("cp_icon") then
                    ...
                    Items["PaletteIcon"]:OnHoverLeave(function()
                        Items["PaletteIcon"]:Tween(nil, {ImageColor3 = FromRGB(180, 180, 180)})
                    end)
                end
            ...
            -- Черно-белые сохраненные цвета
            local Colors = {
                ["White"] = FromRGB(255, 255, 255),
                ["Light Gray"] = FromRGB(200, 200, 200),
                ["Gray"] = FromRGB(150, 150, 150),
                ["Dark Gray"] = FromRGB(100, 100, 100),
                ["Charcoal"] = FromRGB(60, 60, 60),
                ["Almost Black"] = FromRGB(30, 30, 30),
                ["Black"] = FromRGB(0, 0, 0),
                ["Pure White"] = FromRGB(255, 255, 255),
                ["Silver"] = FromRGB(192, 192, 192),
                ["Slate"] = FromRGB(112, 128, 144),
                ["Off White"] = FromRGB(245, 245, 245),
                ["Smoke"] = FromRGB(105, 105, 105),
                ["Ash"] = FromRGB(178, 190, 181),
                ["Graphite"] = FromRGB(56, 56, 56),
                ["Platinum"] = FromRGB(229, 228, 226),
            }

            AddColor(Colors["White"])
            AddColor(Colors["Light Gray"])
            AddColor(Colors["Gray"])
            AddColor(Colors["Dark Gray"])
            AddColor(Colors["Charcoal"])
            AddColor(Colors["Almost Black"])
            AddColor(Colors["Black"])
            AddColor(Colors["Pure White"])
            AddColor(Colors["Silver"])
            AddColor(Colors["Slate"])
            AddColor(Colors["Off White"])
            AddColor(Colors["Smoke"])
            AddColor(Colors["Ash"])
            AddColor(Colors["Graphite"])
            AddColor(Colors["Platinum"])
        ...
        Library.KeybindList = function(self, Title)
            ...
            local Items = { } do 
                ...
                Instances:Create("UIGradient", {
                    Parent = Items["Icon"].Instance,
                    Name = "\0",
                    Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(200, 200, 200)), RGBSequenceKeypoint(1, FromRGB(255, 255, 255))}
                }):AddToTheme({Color = function()
                    return RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, Library.Theme.AccentGradient)}
                end})
    ...
    -- ============================================
    -- ФИНАЛЬНАЯ РЕГИСТРАЦИЯ drochik ui
    -- by ar0sla (github) & voidena
    -- ============================================
    print("[drochik ui] Loaded successfully | by ar0sla (github) & voidena")
    print("[drochik ui] Background image: rbxassetid://137996491500110")
    print("[drochik ui] Theme: Black & White")

    getgenv().Library = Library
    getgenv().drochik_ui = Library
end
